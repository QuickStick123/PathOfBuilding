...
local preFlagList = {
	-- Weapon types
	["^axe attacks {have|deal} "] = { flags = ModFlag.Axe },
	["^axe or sword attacks {have|deal} "] = { tag = { type = "ModFlagOr", modFlags = bor(ModFlag.Axe, ModFlag.Sword) } },
	["^bow attacks {have|deal} "] = { flags = ModFlag.Bow },
	["^claw attacks {have|deal} "] = { flags = ModFlag.Claw },
	["^claw or dagger attacks {have|deal} "] = { tag = { type = "ModFlagOr", modFlags = bor(ModFlag.Claw, ModFlag.Dagger) } },
	["^dagger attacks {have|deal} "] = { flags = ModFlag.Dagger },
	["^mace or sceptre attacks {have|deal} "] = { flags = ModFlag.Mace },
	["^mace, sceptre or staff attacks {have|deal} "] = { tag = { type = "ModFlagOr", modFlags = bor(ModFlag.Mace, ModFlag.Staff) } },
	["^staff attacks {have|deal} "] = { flags = ModFlag.Staff },
	["^sword attacks {have|deal} "] = { flags = ModFlag.Sword },
	["^wand attacks {have|deal} "] = { flags = ModFlag.Wand },
	["^unarmed attacks {have|deal} "] = { flags = ModFlag.Unarmed },
	["^attacks with one handed weapons {have|deal} "] = { flags = ModFlag.Weapon1H },
	["^attacks with two handed weapons {have|deal} "] = { flags = ModFlag.Weapon2H },
	["^attacks with melee weapons {have|deal} "] = { flags = ModFlag.WeaponMelee },
	["^attacks with one handed melee weapons {have|deal} "] = { flags = bor(ModFlag.Weapon1H, ModFlag.WeaponMelee) },
	["^attacks with two handed melee weapons {have|deal} "] = { flags = bor(ModFlag.Weapon2H, ModFlag.WeaponMelee) },
	["^attacks with ranged weapons {have|deal} "] = { flags = ModFlag.WeaponRanged },
	-- Damage types
	...
	["^minions {have|deal} "] = { addToMinion = true },
	["^while a unique enemy is in your presence, minions {have|deal} "] = { addToMinion = true, playerTag = { type = "ActorCondition", actor = "enemy", var = "RareOrUnique" } },
	["^while a pinnacle atlas boss is in your presence, minions {have|deal} "] = { addToMinion = true, playerTag = { type = "ActorCondition", actor = "enemy", var = "PinnacleBoss" } },
	["^minions leech "] = { addToMinion = true },
	["^minions' attacks deal "] = { addToMinion = true, flags = ModFlag.Attack },
	["^golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillType", skillType = SkillType.Golem } },
	["^summoned golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillType", skillType = SkillType.Golem } },
	["^golem skills have "] = { tag = { type = "SkillType", skillType = SkillType.Golem } },
	["^zombies {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Raise Zombie" } },
	["^raised zombies {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Raise Zombie" } },
	["^skeletons {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Skeleton" } },
	["^raging spirits {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Raging Spirit" } },
	["^summoned raging spirits {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Raging Spirit" } },
	["^spectres {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Raise Spectre" } },
	["^chaos golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Chaos Golem" } },
	["^summoned chaos golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Chaos Golem" } },
	["^flame golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Flame Golem" } },
	["^summoned flame golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Flame Golem" } },
	["^ice golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Ice Golem" } },
	["^summoned ice golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Ice Golem" } },
	["^lightning golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Lightning Golem" } },
	["^summoned lightning golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Lightning Golem" } },
	["^stone golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Stone Golem" } },
	["^summoned stone golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Stone Golem" } },
	["^summoned carrion golems {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Carrion Golem" } },
	["^summoned skitterbots {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Carrion Golem" } },
	["^blink arrow and blink arrow clones {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Blink Arrow" } },
	["^mirror arrow and mirror arrow clones {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Mirror Arrow" } },
	["^animated weapons {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Animate Weapon" } },
	["^animated guardians? deals? "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Animate Guardian" } },
	["^summoned holy relics {have|deal} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Holy Relic" } },
	["^summoned reaper {deals?|has} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Reaper" } },
	["^summoned arbalists {have|deal|gain|fire} "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Arbalists" } },
	["^summoned arbalists' attacks have "] = { addToMinion = true, addToMinionTag = { type = "SkillName", skillName = "Summon Arbalists" } },
	["^herald skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.Herald } },
	...
	["^spells cast by totems {have|deal} "] = { flags = ModFlag.Spell, keywordFlags = KeywordFlag.Totem },
	["^trap and mine damage "] = { keywordFlags = bor(KeywordFlag.Trap, KeywordFlag.Mine) },
	["^skills used by traps {have|deal|gain} "] = { keywordFlags = KeywordFlag.Trap },
	["^skills which throw traps {have|deal|gain} "] = { keywordFlags = KeywordFlag.Trap },
	["^skills used by mines {have|deal|gain} "] = { keywordFlags = KeywordFlag.Mine },
	["^skills which throw mines {have|deal|gain} "] = { keywordFlags = KeywordFlag.Mine },
	-- Local damage
	["^attacks with this weapon "] = { tagList = { { type = "Condition", var = "{Hand}Attack" }, { type = "SkillType", skillType = SkillType.Attack } } },
	["^attacks with this weapon {have|deal} "] = { tagList = { { type = "Condition", var = "{Hand}Attack" }, { type = "SkillType", skillType = SkillType.Attack } } },
	["^hits with this weapon {have|deal} "] = { flags = ModFlag.Hit, tagList = { { type = "Condition", var = "{Hand}Attack" }, { type = "SkillType", skillType = SkillType.Attack } } },
	-- Skill types
	["^attacks {have|deal} "] = { flags = ModFlag.Attack },
	["^attack skills {have|deal} "] = { keywordFlags = KeywordFlag.Attack },
	["^spells {have|deal} a? ?"] = { flags = ModFlag.Spell },
	["^spell skills {have|deal} "] = { keywordFlags = KeywordFlag.Spell },
	["^projectile attack skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.RangedAttack } },
	["^projectiles from attacks {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.RangedAttack } },
	["^arrows {have|deal} "] = { keywordFlags = KeywordFlag.Bow },
	["^bow skills {have|deal|fire} "] = { keywordFlags = KeywordFlag.Bow },
	["^projectiles {have|deal|fire} "] = { flags = ModFlag.Projectile },
	...
	["^lightning skills {have|deal} a? ?"] = { keywordFlags = KeywordFlag.Lightning },
	["^lightning spells {have|deal} a? ?"] = { keywordFlags = KeywordFlag.Lightning, flags = ModFlag.Spell },
	["^cold skills {have|deal} a? ?"] = { keywordFlags = KeywordFlag.Cold },
	["^cold spells {have|deal} a? ?"] = { keywordFlags = KeywordFlag.Cold, flags = ModFlag.Spell },
	["^fire skills {have|deal} a? ?"] = { keywordFlags = KeywordFlag.Fire },
	["^fire spells {have|deal} a? ?"] = { keywordFlags = KeywordFlag.Fire, flags = ModFlag.Spell },
	["^chaos skills {have|deal} a? ?"] = { keywordFlags = KeywordFlag.Chaos },
	["^vaal skills {have|deal} "] = { keywordFlags = KeywordFlag.Vaal },
	["^brand skills {have|deal} "] = { keywordFlags = KeywordFlag.Brand },
	["^channelling skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.Channel } },
	["^curse skills {have|deal} "] = { keywordFlags = KeywordFlag.Curse },
	["^hex skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.Hex } },
	["^mark skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.Mark } },
	["^melee skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.Melee } },
	["^guard skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.Guard } },
	["^nova spells {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.Nova } },
	["^area skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.Area } },
	["^aura skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.Aura } },
	["^prismatic skills {have|deal} "] = { tag = { type = "SkillType", skillType = SkillType.RandomElement } },
	...
	["^skills {have|deal|gain|fire} "] = { },
	-- Slot specific
	["^left ring slot: "] = { tag = { type = "SlotNumber", num = 1 } },
	["^right ring slot: "] = { tag = { type = "SlotNumber", num = 2 } },
	["^socketed gems {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}" } },
	["^socketed skills {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}" } },
	["^socketed travel skills {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "travel" } },
	["^socketed warcry skills {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "warcry" } },
	["^socketed attacks {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "attack" } },
	["^socketed spells {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "spell" } },
	["^socketed curse gems {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "curse" } },
	["^socketed melee gems {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "melee" } },
	["^socketed golem gems {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "golem" } },
	["^socketed golem skills {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "golem" } },
	["^socketed golem skills have minions "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "golem" } },
	["^socketed vaal skills {have|deal|gain} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}", keyword = "vaal" } },
	["^socketed projectile spells {have|deal|gain|fire} "] = { addToSkill = { type = "SocketedIn", slotName = "{SlotName}" }, tagList = { { type = "SkillType", skillType= SkillType.Projectile }, { type = "SkillType", skillType = SkillType.Spell } } },
	-- Enemy modifiers
	["^enemies withered by you {take|have} "] = { tag = { type = "MultiplierThreshold", var = "WitheredStack", threshold = 1 }, applyToEnemy = true },
	...
	["^enemies affected by your spider's webs {take|have|deal} "] = { tag = { type = "MultiplierThreshold", var = "Spider's WebStack", threshold = 1 }, applyToEnemy = true },
	...
	["^your flasks grant "] = { },
	["^when hit, "] = { },
	["^you and allies {have|deal|gain} "] = { },
	["^auras from your skills grant "] = { addToAura = true },
	["^you and nearby allies "] = { newAura = true },
	["^you and nearby allies {have|deal|gain} "] = { newAura = true },
	["^nearby allies {have|deal|gain} "] = { newAura = true, newAuraOnlyAllies = true },
	["^you and allies affected by auras from your skills {have|deal|gain} "] = { tag = { type = "Condition", var = "AffectedByAura" } },
...
local modTagList = {
	...
	["{while|if} you have at least (%d+) strength"] = function(num) return { tag = { type = "StatThreshold", stat = "Str", threshold = num } } end,
	["{while|if} you have at least (%d+) dexterity"] = function(num) return { tag = { type = "StatThreshold", stat = "Dex", threshold = num } } end,
	["{while|if} you have at least (%d+) intelligence"] = function(num) return { tag = { type = "StatThreshold", stat = "Int", threshold = num } } end,
	...
	["{while|if} you have at least (%d+) maximum energy shield"] = function(num) return { tag = { type = "StatThreshold", stat = "EnergyShield", threshold = num } } end,
	...
	["{while|if} you have at least (%d+) devotion"] = function(num) return { tag = { type = "StatThreshold", stat = "Devotion", threshold = num } } end,
	...
	["{inflicted|{from }?hits?} with this weapon"] = { tagList = { { type = "Condition", var = "{Hand}Attack" }, { type = "SkillType", skillType = SkillType.Attack } } },
	...
	["x on low life"] = { tag = { type = "Condition", var = "LowLife" } },
	["on reaching low life"] = { tag = { type = "Condition", var = "LowLife" } },
	["{when|while} not on low life"] = { tag = { type = "Condition", var = "LowLife", neg = true } },
	["{when|while} on low mana"] = { tag = { type = "Condition", var = "LowMana" } },
	["{when|while} not on low mana"] = { tag = { type = "Condition", var = "LowMana", neg = true } },
	["{when|while} on full life"] = { tag = { type = "Condition", var = "FullLife" } },
	["{when|while} not on full life"] = { tag = { type = "Condition", var = "FullLife", neg = true } },
	["{when|while} no life is reserved"] = { tag = { type = "StatThreshold", stat = "LifeReserved", threshold = 0, upper = true } },
	["{when|while} no mana is reserved"] = { tag = { type = "StatThreshold", stat = "ManaReserved", threshold = 0, upper = true } },
	["{when|while} on full energy shield"] = { tag = { type = "Condition", var = "FullEnergyShield" } },
	["{when|while} not on full energy shield"] = { tag = { type = "Condition", var = "FullEnergyShield", neg = true } },
	["{when|while} you have energy shield"] = { tag = { type = "Condition", var = "HaveEnergyShield" } },
	["{when|while} you have no energy shield"] = { tag = { type = "Condition", var = "HaveEnergyShield", neg = true } },
	...
	["while {there is }?{a }?rare or unique enemy {is }?nearby"] = { tag = { type = "ActorCondition", actor = "enemy", varList = { "NearbyRareOrUniqueEnemy", "RareOrUnique" } } },
	["if {you've|you have} hit recently"] = { tag = { type = "Condition", var = "HitRecently" } },
	["if {you've|you have} hit an enemy recently"] = { tag = { type = "Condition", var = "HitRecently" } },
	["if {you've|you have} hit with your main hand weapon recently"] = { tag = { type = "Condition", var = "HitRecentlyWithWeapon" } },
	["if {you've|you have} hit with your off hand weapon recently"] = { tagList = { { type = "Condition", var = "HitRecentlyWithWeapon" }, { type = "Condition", var = "DualWielding" } } },
	["if {you've|you have} hit a cursed enemy recently"] = { tagList = { { type = "Condition", var = "HitRecently" }, { type = "ActorCondition", actor = "enemy", var = "Cursed" } } },
	["if {you've|you have} crit recently"] = { tag = { type = "Condition", var = "CritRecently" } },
	["if {you've|you have} dealt a critical strike recently"] = { tag = { type = "Condition", var = "CritRecently" } },
	["if {you've|you have} dealt a critical strike with this weapon recently"] = { tag = { type = "Condition", var = "CritRecently" } }, -- Replica Kongor's
	["if {you've|you have} crit in the past 8 seconds"] = { tag = { type = "Condition", var = "CritInPast8Sec" } },
	["if {you've|you have} dealt a crit in the past 8 seconds"] = { tag = { type = "Condition", var = "CritInPast8Sec" } },
	["if {you've|you have} dealt a critical strike in the past 8 seconds"] = { tag = { type = "Condition", var = "CritInPast8Sec" } },
	...
	["if {you've|you have} dealt a non%-critical strike recently"] = { tag = { type = "Condition", var = "NonCritRecently" } },
	...
	["if {you've|you have} dealt a critical strike with a two handed melee weapon recently"] = { flags = bor(ModFlag.Weapon2H, ModFlag.WeaponMelee), tag = { type = "Condition", var = "CritRecently" } },
	["if {you've|you have} killed recently"] = { tag = { type = "Condition", var = "KilledRecently" } },
	["if {you've|you have} killed an enemy recently"] = { tag = { type = "Condition", var = "KilledRecently" } },
	["if {you've|you have} killed at least (%d) enemies recently"] = function(num) return { tag = { type = "MultiplierThreshold", var = "EnemyKilledRecently", threshold = num } } end,
	...
	["if {you've|you have} thrown a trap or mine recently"] = { tag = { type = "Condition", var = "TrapOrMineThrownRecently" } },
	["on throwing a trap"] = { tag = { type = "Condition", var = "TrapOrMineThrownRecently" } },
	["if {you've|you have} killed a maimed enemy recently"] = { tagList = { { type = "Condition", var = "KilledRecently" }, { type = "ActorCondition", actor = "enemy", var = "Maimed" } } },
	["if {you've|you have} killed a cursed enemy recently"] = { tagList = { { type = "Condition", var = "KilledRecently" }, { type = "ActorCondition", actor = "enemy", var = "Cursed" } } },
	["if {you've|you have} killed a bleeding enemy recently"] = { tagList = { { type = "Condition", var = "KilledRecently" }, { type = "ActorCondition", actor = "enemy", var = "Bleeding" } } },
	["if {you've|you have} killed an enemy affected by your damage over time recently"] = { tag = { type = "Condition", var = "KilledAffectedByDotRecently" } },
	["if {you've|you have} frozen an enemy recently"] = { tag = { type = "Condition", var = "FrozenEnemyRecently" } },
	["if {you've|you have} chilled an enemy recently"] = { tag = { type = "Condition", var = "ChilledEnemyRecently" } },
	["if {you've|you have} ignited an enemy recently"] = { tag = { type = "Condition", var = "IgnitedEnemyRecently" } },
	["if {you've|you have} shocked an enemy recently"] = { tag = { type = "Condition", var = "ShockedEnemyRecently" } },
	["if {you've|you have} stunned an enemy recently"] = { tag = { type = "Condition", var = "StunnedEnemyRecently" } },
	["if {you've|you have} stunned an enemy with a two handed melee weapon recently"] = { flags = bor(ModFlag.Weapon2H, ModFlag.WeaponMelee), tag = { type = "Condition", var = "StunnedEnemyRecently" } },
	["if {you've|you have} been hit recently"] = { tag = { type = "Condition", var = "BeenHitRecently" } },
	["if {you've|you have} been hit by an attack recently"] = { tag = { type = "Condition", var = "BeenHitByAttackRecently" } },
	...
	["if {you've|you have} taken a critical strike recently"] = { tag = { type = "Condition", var = "BeenCritRecently" } },
	["if {you've|you have} taken a savage hit recently"] = { tag = { type = "Condition", var = "BeenSavageHitRecently" } },
	["if you {haven't|have not} been hit recently"] = { tag = { type = "Condition", var = "BeenHitRecently", neg = true } },
	["if you {haven't|have not} been hit by an attack recently"] = { tag = { type = "Condition", var = "BeenHitByAttackRecently", neg = true } },
	["if {you've|you have} taken no damage from hits recently"] = { tag = { type = "Condition", var = "BeenHitRecently", neg = true } },
	["if {you've|you have} taken fire damage from a hit recently"] = { tag = { type = "Condition", var = "HitByFireDamageRecently" } },
	["if {you've|you have} taken fire damage from an enemy hit recently"] = { tag = { type = "Condition", var = "TakenFireDamageFromEnemyHitRecently" } },
	["if {you've|you have} taken spell damage recently"] = { tag = { type = "Condition", var = "HitBySpellDamageRecently" } },
	["if you haven't taken damage recently"] = { tag = { type = "Condition", var = "BeenHitRecently", neg = true } },
	["if {you've|you have} blocked recently"] = { tag = { type = "Condition", var = "BlockedRecently" } },
	["if you haven't blocked recently"] = { tag = { type = "Condition", var = "BlockedRecently", neg = true } },
	["if {you've|you have} blocked an attack recently"] = { tag = { type = "Condition", var = "BlockedAttackRecently" } },
	["if {you've|you have} blocked attack damage recently"] = { tag = { type = "Condition", var = "BlockedAttackRecently" } },
	["if {you've|you have} blocked a spell recently"] = { tag = { type = "Condition", var = "BlockedSpellRecently" } },
	["if {you've|you have} blocked spell damage recently"] = { tag = { type = "Condition", var = "BlockedSpellRecently" } },
	["if {you've|you have} blocked damage from a unique enemy in the past 10 seconds"] = { tag = { type = "Condition", var = "BlockedHitFromUniqueEnemyInPast10Sec" } },
	["if {you've|you have} attacked recently"] = { tag = { type = "Condition", var = "AttackedRecently" } },
	["if {you've|you have} cast a spell recently"] = { tag = { type = "Condition", var = "CastSpellRecently" } },
	["if {you've|you have} consumed a corpse recently"] = { tag = { type = "Condition", var = "ConsumedCorpseRecently" } },
	["if {you've|you have} cursed an enemy recently"] = { tag = { type = "Condition", var = "CursedEnemyRecently" } },
	["if {you've|you have} cast a mark spell recently"] = { tag = { type = "Condition", var = "CastMarkRecently" } },
	["if you {haven't|have not} consumed a corpse recently"] = { tag = { type = "Condition", var = "ConsumedCorpseRecently", neg = true } },
	["for each corpse consumed recently"] = { tag = { type = "Multiplier", var = "CorpseConsumedRecently" } },
	["if {you've|you have} taunted an enemy recently"] = { tag = { type = "Condition", var = "TauntedEnemyRecently" } },
	["if {you've|you have} used a skill recently"] = { tag = { type = "Condition", var = "UsedSkillRecently" } },
	["if {you've|you have} used a travel skill recently"] = { tag = { type = "Condition", var = "UsedTravelSkillRecently" } },
	...
	["if {you've|you have} used a warcry recently"] = { tag = { type = "Condition", var = "UsedWarcryRecently" } },
	["if {you've|you have} warcried recently"] = { tag = { type = "Condition", var = "UsedWarcryRecently" } },
	["for each time {you've|you have} warcried recently"] = { tag = { type = "Multiplier", var = "WarcryUsedRecently" } },
	["when you warcry"] = { tag = { type = "Condition", var = "UsedWarcryRecently" } },
	["if {you've|you have} warcried in the past 8 seconds"] = { tag = { type = "Condition", var = "UsedWarcryInPast8Seconds" } },
	...
	["if {you've|you have} used a fire skill recently"] = { tag = { type = "Condition", var = "UsedFireSkillRecently" } },
	["if {you've|you have} used a cold skill recently"] = { tag = { type = "Condition", var = "UsedColdSkillRecently" } },
	["if {you've|you have} used a fire skill in the past 10 seconds"] = { tag = { type = "Condition", var = "UsedFireSkillInPast10Sec" } },
	["if {you've|you have} used a cold skill in the past 10 seconds"] = { tag = { type = "Condition", var = "UsedColdSkillInPast10Sec" } },
	["if {you've|you have} used a lightning skill in the past 10 seconds"] = { tag = { type = "Condition", var = "UsedLightningSkillInPast10Sec" } },
	["if {you've|you have} summoned a totem recently"] = { tag = { type = "Condition", var = "SummonedTotemRecently" } },
	...
	["if {you've|you have} used a minion skill recently"] = { tag = { type = "Condition", var = "UsedMinionSkillRecently" } },
	["if {you've|you have} used a movement skill recently"] = { tag = { type = "Condition", var = "UsedMovementSkillRecently" } },
	["if you haven't cast dash recently"] = { tag = { type = "Condition", var = "CastDashRecently", neg = true } },
	["if {you've|you have} cast dash recently"] = { tag = { type = "Condition", var = "CastDashRecently" } },
	["if {you've|you have} used a vaal skill recently"] = { tag = { type = "Condition", var = "UsedVaalSkillRecently" } },
	["if {you've|you have} used a socketed vaal skill recently"] = { tag = { type = "Condition", var = "UsedVaalSkillRecently" } },
	...
	["if {you've|you have} used a brand skill recently"] = { tag = { type = "Condition", var = "UsedBrandRecently" } },
	["if {you've|you have} spent (%d+) total mana recently"] = function(num) return { tag = { type = "MultiplierThreshold", var = "ManaSpentRecently", threshold = num } } end,
	["if {you've|you have} spent life recently"] = { tag = { type = "MultiplierThreshold", var = "LifeSpentRecently", threshold = 1 } },
	...
	["if {you've|you have} detonated a mine recently"] = { tag = { type = "Condition", var = "DetonatedMinesRecently" } },
	...
	["by {slain }?rare {and|or} unique enemies"] = { tag = { type = "ActorCondition", actor = "enemy", var = "RareOrUnique" } },
	...
	-- Enemy multipliers
	["per freeze, shock {and|or} ignite on enemy"] = { tag = { type = "Multiplier", var = "FreezeShockIgniteOnEnemy" } },
...
local specialModList = {
	...
	["{immune|immunity} to elemental ailments while on consecrated ground"] = function()
		local mods = { }
		for i, ailment in ipairs(data.elementalAilmentTypeList) do
			mods[i] = mod("Avoid"..ailment, "BASE", 100, { type = "Condition", var = "OnConsecratedGround" }, { type = "GlobalEffect", effectType = "Global", unscalable = true })
		end
		return mods
	end,
	-- Assassin
	...
	["{immune|immunity} to elemental ailments while affected by glorious madness"] = function()
		local mods = { }
		for i, ailment in ipairs(data.elementalAilmentTypeList) do
			mods[i] = mod("Avoid"..ailment, "BASE", 100, { type = "Condition", var = "AffectedByGloriousMadness" }, { type = "GlobalEffect", effectType = "Global", unscalable = true })
		end
		return mods
	end,
	["{immune|immunity} to elemental ailments while focus?sed"] = function()
		local mods = { }
		for i, ailment in ipairs(data.elementalAilmentTypeList) do
			mods[i] = mod("Avoid"..ailment, "BASE", 100, { type = "Condition", var = "Focused" }, { type = "GlobalEffect", effectType = "Global", unscalable = true })
		end
		return mods
	end,
	...
	["attack damage is lucky if {you've|you have} blocked in the past (%d+) seconds"] = {
		flag("LuckyHits", nil, ModFlag.Attack, { type = "Condition", var = "BlockedRecently" })
	},
	["hits ignore enemy monster physical damage reduction if {you've|you have} blocked in the past (%d+) seconds"] = {
	...
	["{immune|immunity} to elemental ailments while you have arcane surge"] = function()
		local mods = { }
		for i, ailment in ipairs(data.elementalAilmentTypeList) do
			mods[i] = mod("Avoid"..ailment, "BASE", 100, { type = "Condition", var = "AffectedByArcaneSurge" }, { type = "GlobalEffect", effectType = "Global", unscalable = true })
		end
		return mods
	end,
	...
	["consecrated ground you create grants {immune|immunity} to elemental ailments to you and allies"] = function()
		local mods = { }
		for i, ailment in ipairs(data.elementalAilmentTypeList) do
	...
	["cannot be stunned while you have energy shield"] = { mod("AvoidStun", "BASE", 100, { type = "Condition", var = "HaveEnergyShield" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	...
	["{immune|immunity} to elemental ailments during any flask effect"] = function()
		local mods = { }
		for i, ailment in ipairs(data.elementalAilmentTypeList) do
			mods[i] = mod("Avoid"..ailment, "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true })
		end
		return mods
	end,
	-- Raider
	...
	["{immune|immunity} to elemental ailments while phasing"] = function()
		local mods = { }
		for i, ailment in ipairs(data.elementalAilmentTypeList) do
			mods[i] = mod("Avoid"..ailment, "BASE", 100, { type = "Condition", var = "Phasing" }, { type = "GlobalEffect", effectType = "Global", unscalable = true })
		end
		return mods
	end,
	...
	-- Saboteur
	["{immune|immunity} to ignite and shock"] = {
	...
	["cannot be stunned while leeching"] = { mod("AvoidStun", "BASE", 100, { type = "Condition", var = "Leeching" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["you are immune to bleeding while leeching"] = { mod("AvoidBleed", "BASE", 100, { type = "Condition", var = "Leeching" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	...
	["cannot be stunned while you have ghost shrouds"] = function(num) return { mod("AvoidStun", "BASE", 100, { type = "MultiplierThreshold", var = "GhostShroud", threshold = 1 }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) } end,
	...
	["(%d+)%% chance to {cast|trigger} socketed spells when you spend at least (%d+) mana to use a skill"] = function(num, _, amount) return {
	...
	["([%+%-]%d+)%% to quality of all skill gems"] = function(num) return { mod("GemProperty", "LIST", { keyword = "active_skill", key = "quality", value = num }) } end,
	...
	["{cast|trigger}s? level (%d+) (.+) when equipped"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	["{cast|trigger}s? level (%d+) (.+) on %a+"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	["use level (%d+) (.+) on %a+"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	["{cast|trigger}s? level (%d+) (.+) when you attack"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	["{cast|trigger}s? level (%d+) (.+) when you deal a critical strike"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	["{cast|trigger}s? level (%d+) (.+) when hit"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	["{cast|trigger}s? level (%d+) (.+) when you kill an enemy"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	["{cast|trigger}s? level (%d+) (.+) when you use a skill"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	...
	["%d+%% chance to trigger level (%d+) (.+) {when you|on} kill{ an enemy}?"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	...
	["%d+%% chance to {cast|trigger} level (%d+) (.+) on %a+"] = function(num, _, skill) return triggerExtraSkill(skill, num) end,
	...
	["%d+%% chance to curse (non%-cursed )?enemies with (%D+) on %a+, with (%d+)%% increased effect"] = function(_, skill, num) return {
		mod("ExtraSkill", "LIST", { skillId = gemIdLookup[skill], level = 1, noSupports = true, triggered = true }),
		mod("CurseEffect", "INC", tonumber(num), { type = "SkillName", skillName = string.gsub(" "..skill, "%W%l", string.upper):sub(2) }),
	} end,
	["%d+%% chance to curse (non%-cursed )?enemies with (%D+) on %a+"] = function(_, skill) return {
		mod("ExtraSkill", "LIST", { skillId = gemIdLookup[skill], level = 1, noSupports = true, triggered = true }),
	} end,
	...
	["{cast|trigger}s? (.+) on %a+"] = function(_, skill) return triggerExtraSkill(skill, 1, true) end,
	["{attack|trigger} (.+) on %a+"] = function(_, skill) return triggerExtraSkill(skill, 1, true) end,
	["{attack|trigger} with (.+) on %a+"] = function(_, skill) return triggerExtraSkill(skill, 1, true) end,
	["{cast|trigger}s? (.+) when hit"] = function(_, skill) return triggerExtraSkill(skill, 1, true) end,
	["{attack|trigger} (.+) when hit"] = function(_, skill) return triggerExtraSkill(skill, 1, true) end,
	["{attack|trigger} with (.+) when hit"] = function(_, skill) return triggerExtraSkill(skill, 1, true) end,
	["{cast|trigger}s? (.+) when your skills or minions kill"] = function(_, skill) return triggerExtraSkill(skill, 1, true) end,
	["{attack|trigger} (.+) when you take a critical strike"] = function( _, skill) return triggerExtraSkill(skill, 1, true) end,
	["{attack|trigger} with (.+) when you take a critical strike"] = function( _, skill) return triggerExtraSkill(skill, 1, true) end,
	...
	["socketed [%a+]* ?gems {are }?supported by level (%d+) (.+)"] = function(num, _, support)
	...
	["gain (%d+)%% of weapon physical damage as extra damage of an? {random }?element"] = function(num) return { mod("PhysicalDamageGainAsRandom", "BASE", num, nil, ModFlag.Weapon) } end,
	...
	["critical strikes do not {always|inherently }?freeze"] = { flag("CritsDontAlwaysFreeze") },
	...
	["{immune|immunity} to elemental ailments while on consecrated ground if you have at least (%d+) devotion"] = function(num)
		local mods = { }
		for i, ailment in ipairs(data.elementalAilmentTypeList) do
			mods[i] = mod("Avoid"..ailment, "BASE", 100, { type = "Condition", var = "OnConsecratedGround" }, { type = "StatThreshold", stat = "Devotion", threshold = num }, { type = "GlobalEffect", effectType = "Global", unscalable = true })
		end
		return mods
	end,
	...
	-- Poison
	["{your }?fire damage can poison"] = { flag("FireCanPoison") },
	["{your }?cold damage can poison"] = { flag("ColdCanPoison") },
	["{your }?lightning damage can poison"] = { flag("LightningCanPoison") },
	...
	["{when|while} at maximum frenzy charges, attacks poison enemies"] = { mod("PoisonChance", "BASE", 100, nil, ModFlag.Attack, { type = "StatThreshold", stat = "FrenzyCharges", thresholdStat = "FrenzyChargesMax" }) },
	...
	["non%-aura hexes expire upon reaching (%d+)%% of base effect non%-aura hexes gain (%d+)%% increased effect per second"] = function(limit, _, num) return {
		mod("CurseEffect", "INC", tonumber(num), { type = "Multiplier", actor = "enemy", var = "CurseDurationExpired", limit = tonumber(limit), limitTotal = true }, { type = "SkillType", skillType = SkillType.Aura, neg = true } )
	} end,
	...
	["and nearby allies regenerate (%d+) life per second"] = function(num) return { mod("LifeRegen", "BASE", num, { type = "Condition", var = "KilledPoisonedLast2Seconds" }) } end,
	...
	["{inflict }?(.+) exposure on hit if you've cast (.+) in the past (%d+) seconds"] = function (_, exposureType, curse) return {
	...
	["can {have|summon} 1 additional siege ballista totem per (%d+) dexterity"] = function(num) return { mod("ActiveBallistaLimit", "BASE", 1, { type = "SkillName", skillName = "Siege Ballista" }, { type = "PerStat", stat = "Dex", div = num }) } end,
	["totems fire (%d+) additional projectiles"] = function(num) return { mod("ProjectileCount", "BASE", num, nil, 0, KeywordFlag.Totem) } end,
	["([%d%.]+)%% of damage dealt by {your }?totems is leeched to you as life"] = function(num) return { mod("DamageLifeLeechToPlayer", "BASE", num, nil, 0, KeywordFlag.Totem) } end,
	["([%d%.]+)%% of damage dealt by {your }?mines is leeched to you as life"] = function(num) return { mod("DamageLifeLeechToPlayer", "BASE", num, nil, 0, KeywordFlag.Mine) } end,
	...
	["{summoned }?raging spirits' hits always ignite"] = { mod("MinionModifier", "LIST", { mod = mod("EnemyIgniteChance", "BASE", 100) }, { type = "SkillName", skillName = "Summon Raging Spirit" }) },
	...
	["summoned skeleton warriors {and soldiers }?wield {a copy of }?this weapon while in your main hand"] = { }, -- just make the mod blue, handled in CalcSetup
	...
	["chaos damage {taken }?does not bypass minions' energy shield"] = { mod("MinionModifier", "LIST", { mod = flag("ChaosNotBypassEnergyShield") }) },
	...
	["spells {have|fire} an additional projectile"] = { mod("ProjectileCount", "BASE", 1, nil, ModFlag.Spell) },
	...
	["left ring slot: your chilling skitterbot's aura applies socketed {hex }?curse instead"] = { flag("SkitterbotsCannotChill", { type = "SlotNumber", num = 1 }) },
	...
	["right ring slot: your shocking skitterbot's aura applies socketed {hex }?curse instead"] = { flag("SkitterbotsCannotShock", { type = "SlotNumber", num = 2 }) },
	...
	["life and mana leech are instant during {flask }?effect"] = { flag("InstantLifeLeech", { type = "Condition", var = "UsingFlask" }), flag("InstantManaLeech", { type = "Condition", var = "UsingFlask" }) },
	...
	-- Defences
	["chaos damage {taken }?does not bypass energy shield"] = { flag("ChaosNotBypassEnergyShield") },
	["(%d+)%% of chaos damage {taken }?does not bypass energy shield"] = function(num) return { mod("ChaosEnergyShieldBypass", "BASE", -num) } end,
	["chaos damage {taken }?does not bypass energy shield while not on low life"] = { flag("ChaosNotBypassEnergyShield", { type = "Condition", varList = { "LowLife" }, neg = true }) },
	["chaos damage {taken }?does not bypass energy shield while not on low life or low mana"] = { flag("ChaosNotBypassEnergyShield", { type = "Condition", varList = { "LowLife", "LowMana" }, neg = true }) },
	...
	["cannot gain energy shield during {flask }?effect"] = { flag("CannotGainEnergyShield", { type = "Condition", var = "UsingFlask" }) },
	["cannot gain life during {flask }?effect"] = { flag("CannotGainLife", { type = "Condition", var = "UsingFlask" }) },
	["cannot gain mana during {flask }?effect"] = { flag("CannotGainMana", { type = "Condition", var = "UsingFlask" }) },
	...
	["cannot be stunned"] = { mod("AvoidStun", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	...
	["{immune|immunity} to shock"] = { mod("AvoidShock", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be frozen"] = { mod("AvoidFreeze", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to freeze"] = { mod("AvoidFreeze", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be chilled"] = { mod("AvoidChill", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to chill"] = { mod("AvoidChill", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be ignited"] = { mod("AvoidIgnite", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to ignite"] = { mod("AvoidIgnite", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be ignited while at maximum endurance charges"] = { mod("AvoidIgnite", "BASE", 100, {type = "StatThreshold", stat = "EnduranceCharges", thresholdStat = "EnduranceChargesMax" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["grants immunity to ignite for (%d+) seconds if used while ignited"] = { mod("AvoidIgnite", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }, { type = "Condition", var = "UsingFlask" }) },
	["grants immunity to bleeding for (%d+) seconds if used while bleeding"] = { mod("AvoidBleed", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }, { type = "Condition", var = "UsingFlask" }) },
	["grants immunity to poison for (%d+) seconds if used while poisoned"] = { mod("AvoidPoison", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }, { type = "Condition", var = "UsingFlask" }) },
	["grants immunity to freeze for (%d+) seconds if used while frozen"] = { mod("AvoidFreeze", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }, { type = "Condition", var = "UsingFlask" }) },
	["grants immunity to chill for (%d+) seconds if used while chilled"] = { mod("AvoidChill", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }, { type = "Condition", var = "UsingFlask" }) },
	["grants immunity to shock for (%d+) seconds if used while shocked"] = { mod("AvoidChill", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }, { type = "Condition", var = "UsingFlask" }) },
	["cannot be chilled while at maximum frenzy charges"] = { mod("AvoidChill", "BASE", 100, {type = "StatThreshold", stat = "FrenzyCharges", thresholdStat = "FrenzyChargesMax" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be shocked while at maximum power charges"] = { mod("AvoidShock", "BASE", 100, {type = "StatThreshold", stat = "PowerCharges", thresholdStat = "PowerChargesMax" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["you cannot be shocked while at maximum endurance charges"] = { mod("AvoidShock", "BASE", 100, { type = "StatThreshold", stat = "EnduranceCharges", thresholdStat = "EnduranceChargesMax" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["you cannot be shocked while chilled"] = { mod("AvoidShock", "BASE", 100, { type = "condition", var = "Chilled" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be shocked while chilled"] = { mod("AvoidShock", "BASE", 100, { type = "condition", var = "Chilled" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be shocked if intelligence is higher than strength"] = { mod("AvoidShock", "BASE", 100, { type = "Condition", var = "IntHigherThanStr" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be frozen if dexterity is higher than intelligence"] = { mod("AvoidFreeze", "BASE", 100, { type = "Condition", var = "DexHigherThanInt" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be frozen if energy shield recharge has started recently"] = { mod("AvoidFreeze", "BASE", 100, { type = "Condition", var = "EnergyShieldRechargeRecently" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be ignited if strength is higher than dexterity"] = { mod("AvoidIgnite", "BASE", 100, { type = "Condition", var = "StrHigherThanDex" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be chilled while burning"] = { mod("AvoidChill", "BASE", 100, { type = "Condition", var = "Burning" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be chilled while you have onslaught"] = { mod("AvoidChill", "BASE", 100, { type = "Condition", var = "Onslaught" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be chilled during onslaught"] = { mod("AvoidChill", "BASE", 100, { type = "Condition", var = "Onslaught" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["cannot be inflicted with bleeding"] = { mod("AvoidBleed", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["bleeding cannot be inflicted on you"] = { mod("AvoidBleed", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["you are immune to bleeding"] = { mod("AvoidBleed", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to bleeding and corrupted blood during {flask }?effect"] = { mod("AvoidBleed", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to poison"] = { mod("AvoidPoison", "BASE", 100, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to poison during {flask }?effect"] = { mod("AvoidPoison", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to shock during {flask }?effect"] = { mod("AvoidShock", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to freeze and chill during {flask }?effect"] = {
		mod("AvoidFreeze", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }),
		mod("AvoidChill", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }),
	},
	["{immune|immunity} to freeze and chill while ignited"] = {
		mod("AvoidFreeze", "BASE", 100, { type = "Condition", var = "Ignited" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }),
		mod("AvoidChill", "BASE", 100, { type = "Condition", var = "Ignited" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }),
	},
	["{immune|immunity} to ignite during {flask }?effect"] = { mod("AvoidIgnite", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to bleeding during {flask }?effect"] = { mod("AvoidBleed", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	["{immune|immunity} to curses during {flask }?effect"] = { mod("AvoidCurse", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) },
	...
	["{immune|immunity} to (%a-)s? if you've cast (.+) in the past (%d+) seconds"] = function (_, ailment, curse) return {
		mod("Avoid"..ailment:gsub("^%l", string.upper), "BASE", 100, { type = "Condition", var = "SelfCast"..curse:gsub("^%l", string.upper):gsub(" %l", string.upper):gsub(" ", "") }, { type = "GlobalEffect", effectType = "Global", unscalable = true })
	} end,
	...
	["{immune|immunity} to freeze, chill, curses and stuns during {flask }?effect"] = {
		mod("AvoidFreeze", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }),
		mod("AvoidChill", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }),
		mod("AvoidCurse", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }),
		mod("AvoidStun", "BASE", 100, { type = "Condition", var = "UsingFlask" }, { type = "GlobalEffect", effectType = "Global", unscalable = true }),
	},
	...
	["{immune|immunity} to curses while you have at least (%d+) rage"] = function(num) return { mod("AvoidCurse", "BASE", 100, { type = "MultiplierThreshold", var = "Rage", threshold = num }, { type = "GlobalEffect", effectType = "Global", unscalable = true }) } end,
	...
	["zealot's oath during {flask }?effect"] = { flag("ZealotsOath", { type = "Condition", var = "UsingFlask" }) },
	...
	["recover (%d+)%% of life when you kill an enemy during {flask }?effect"] = function(num) return { mod("LifeOnKill", "BASE", 1, { type = "PercentStat", stat = "Life", percent = num }, { type = "Condition", var = "UsingFlask" }) } end,
	["recover (%d+)%% of mana when you kill an enemy during {flask }?effect"] = function(num) return { mod("ManaOnKill", "BASE", 1, { type = "PercentStat", stat = "Mana", percent = num }, { type = "Condition", var = "UsingFlask" }) } end,
	["recover (%d+)%% of energy shield when you kill an enemy during {flask }?effect"] = function(num) return { mod("EnergyShieldOnKill", "BASE", 1, { type = "PercentStat", stat = "EnergyShield", percent = num }, { type = "Condition", var = "UsingFlask" }) } end,
	...
	["chaos damage {taken }?does not bypass energy shield during effect"] = { flag("ChaosNotBypassEnergyShield") },
	...
	["{your }?skills {cost|have} no mana during {flask }?effect"] = { mod("ManaCost", "MORE", -100, { type = "Condition", var = "UsingFlask" }) },
	...
	["attacks cost life instead of mana"] = { flag("SkillBloodMagic", nil, ModFlag.Attack) },
	...
	["{cast|trigger} a socketed cold {skill|spell} on melee critical strike"] = { mod("ExtraSupport", "LIST", { skillId = "SupportUniqueCosprisMaliceColdSpellsCastOnMeleeCriticalStrike", level = 1 }, { type = "SocketedIn", slotName = "{SlotName}" }) },
	["{cast|trigger} a socketed cold {skill|spell} on melee critical strike, with a ([%d%.]+) second cooldown"] = { mod("ExtraSupport", "LIST", { skillId = "SupportUniqueCosprisMaliceColdSpellsCastOnMeleeCriticalStrike", level = 1 }, { type = "SocketedIn", slotName = "{SlotName}" }) },
	...
	["base critical strike chance of spells is the critical strike chance of {your }?main hand weapon"] = { flag("BaseCritFromMainHand", nil, ModFlag.Spell) }, -- old wordings
	...
	["socketed lightning spells {have|deal} (%d+)%% increased spell damage if triggered"] = { },
...
for gemId, gemData in pairs(data.gems) do
	...
	if not grantedEffect.hidden and not grantedEffect.support then
		...
		if grantedEffect.skillTypes[SkillType.Buff] or grantedEffect.baseFlags.buff then
			...
			preSkillNameList["^"..skillName:lower().." grants (an? )?additional "] = { addToSkill = { type = "SkillName", skillName = skillName }, tag = { type = "GlobalEffect", effectType = "Buff" } }
		end
...
local function scan(line, patternList, plain)
	...
	for pattern, patternVal in pairs(patternList) do
		local index, endIndex, cap1, cap2, cap3, cap4, cap5
		if plain then 
			index, endIndex, cap1, cap2, cap3, cap4, cap5 = lineLower:find(pattern, 1, true)
		else 
			ConPrintf("%s", pattern)		
			index, endIndex, cap1, cap2, cap3, cap4, cap5 = lineLower:matchOrPattern(pattern, "{}")
		end
